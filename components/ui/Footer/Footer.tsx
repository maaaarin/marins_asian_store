...
export const Footer = () => {
  return (
    <footer
      className={`w-full h-auto bg-black mt-5 text-white rounded-t-3xl lg:rounded-t-[5rem]`}>
      <div className="container py-10 flex flex-col gap-8">
        <div className="flex-col flex gap-5  lg:flex-row">
          <div className="w-full flex flex-col items-center gap-5 mb-6 lg:mb-0 lg:w-1/5 lg:items-start">
            <svg
          ...
          <div className="lg:hidden">
            <Accordion
              itemClasses={{
                base: "py-0 px-4 w-full rounded-3xl bg-zinc-950 mb-2",
                title: "font-normal text-white",

                content: "text-medium",
              }}>
              <AccordionItem key="1" aria-label="Explore" title="Explore">
              ...
              <AccordionItem key="2" aria-label="Company" title="Company">
                <ul className="flex flex-col gap-2">
                  <li>About</li>
                  <li>Pricing</li>
                  <li>Our License</li>
              ...
              <AccordionItem key="3" aria-label="Legal" title="Legal">
                <ul className="flex flex-col gap-2">
              ...
              <AccordionItem key="4" aria-label="Support" title="Support">
                <ul className="flex flex-col gap-2">
                  <li>FAQ</li>
                  <li>Contact</li>
                </ul>
          ...
          <div className="hidden w-full flex-col lg:w-4/5 lg:flex-row lg:justify-around lg:flex">
        ...
        <div className="flex-col-reverse gap-6 flex items-center lg:justify-between lg:flex-row">
          <span>© Marín’s. All rights reserved.</span>
          <button className="size-fit flex border border-white rounded-full p-2 gap-2 items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              className="w-6"
