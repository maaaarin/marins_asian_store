...
export const Main = () => {
    return (
        <main className={`${styles.main} container`}>
            <div className={`${styles.bannersHeader} w-full relative mt-5`}>
                    <div className="size-full flex justify-between">
                        <div className={`${styles.bannerHeaderCornerLightYellow} bg-light-yellow rounded-t-2xl relative`}></div>
                        <div className={`${styles.bannerHeaderCornerDarkBlue} bg-primary rounded-t-2xl relative`}></div>
                    </div>
            </div>
                ...
                <div className={`${styles.bannersFirstPanel} h-full flex flex-col`}>
                    <div className="w-full h-4/6 bg-light-yellow text-2xl rounded-bl-3xl rounded-tr-3xl flex flex-col gap-5 justify-end p-8 relative">
                        ...
                        <div className="flex gap-2 items-center">
                            <span>Deals</span>
                            <div className="bg-dark-blue rounded-full text-white px-3 py-2 text-base">
                                Up to 50%
                            </div>
                        ...
                        <Image src="/assets/img/banner_main.png" alt="Banner Main" width={550} height={550} className="h-full aspect-square object-contain absolute right-0 -bottom-20 z-20" />
                        <Image src="/assets/img/banner_bg_1.svg" alt="Banner Background" width={0} height={0} className="h-full w-auto absolute right-0 bottom-0" />
                    </div>
                    <div className="w-full h-2/6 flex">
                        <div className="w-2/4 h-full pt-5">
                            <div className="size-full bg-orange rounded-t-3xl rounded-bl-3xl flex overflow-hidden">
                                <div className="w-2/4 flex flex-col gap-3 text-base text-beige pl-8 py-8">
                                    <span className="font-bold text-2xl text-nowrap">Pocky is Back!</span>
                                    <p className="text-xl">Discover a new Pocky flavor.</p>
                                </div>
                                <div className="w-2/4 relative flex justify-center">
                                    <Image src="/assets/img/banner_item.png" alt="Banner Main" width={250} height={0} objectFit="contain" className="absolute w-2/4 h-auto -bottom-14 z-10" />
                                    <Image src="/assets/img/banner_mesh.svg" alt="alt" width={0} height={0} className="w-full absolute bottom-0 right-0" />
                                </div>
                            </div>
                        </div>
                        <div className="w-2/4 flex flex-col">
                            ...
                            <div className="w-full h-2/4 flex gap-5">
                                ...
                                <div
                                    ...
                                    <Image src="/assets/img/banner_bg_2.svg" alt="Banner Background" width={0} height={0} className="w-full h-auto absolute top-0 bottom-0" />
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className={`${styles.bannersSecondPanel} h-full rounded-b-3xl rounded-tl-3xl relative overflow-hidden`}>
                    <Image
